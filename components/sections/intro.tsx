...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I&apos;m Alison.</span> I&apos;m a{" "}
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          aria-label="Open alison tahiri's linkedin website."
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          aria-label="Open alison tahiri's github website."
        >
          <FaGithubSquare />
        </a>
      </motion.div>
